...
/**
 * REST controller for Destinations.
 */
...
public class DestinationsController {
   ...
   * Constructor.
   *
   * @param destinationQueryService   destination query service
   * @param destinationCommandService destination command service
   */
  public DestinationsController(DestinationQueryService destinationQueryService,
   ...
   *
   * @param resource the create resource
   * @return the created destination resource
   */
  @PostMapping
  public ResponseEntity<DestinationResource> createDestination(
      @RequestBody CreateDestinationResource resource) {
    var createDestinationCommand = CreateDestinationCommandFromResourceAssembler
    ...
    var destinationResource = DestinationResourceFromEntityAssembler
        .toResourceFromEntity(optionalDestination.get());
   ...
   * @return the updated destination resource
   */
  @PutMapping("/{destinationId}")
  public ResponseEntity<DestinationResource> updateDestination(@PathVariable Long destinationId,
                                                               @RequestBody DestinationResource
                                                                   resource) {
    var updateDestinationCommand = UpdateDestinationCommandFromResourceAssembler
        .toCommandFromResource(destinationId, resource);
