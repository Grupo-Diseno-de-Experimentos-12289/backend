...
public class ExperiencesController {
  ...
  public ResponseEntity<ExperienceResource> createExperience(
      @PathVariable Long agencyId, @RequestBody CreateExperienceResource resource) {
    var command =
    ...
    var experienceResource =
        ExperienceResourceFromEntityAssembler.toResourceFromEntity(experience.get());
  ...
  public ResponseEntity<ExperienceResource> updateExperience(
      @PathVariable Long experienceId, @RequestBody UpdateExperienceResource resource) {
    var command =
        UpdateExperienceCommandFromResourceAssembler.toCommandFromResource(resource, experienceId);
    commandService.updateExperience(command);

    return queryService
        .handle(new GetExperienceByIdQuery(experienceId))
        .map(ExperienceResourceFromEntityAssembler::toResourceFromEntity)
