...
@RestController
@RequestMapping(
    value = "/api/v1/agencies/{agencyId}/staff",
...
public class AgencyStaffController {
  ...
  /** Constructs a new AgencyStaffController. */
  public AgencyStaffController(
      AgencyStaffCommandService agencyStaffCommandService,
      AgencyStaffQueryService agencyStaffQueryService) {
  ...
  public ResponseEntity<AgencyStaffResource> createStaff(
      @PathVariable Long agencyId, @RequestBody @Valid CreateAgencyStaffResource resource) {
    try {
      var command =
  ...
  /** Get all staff by agency id. */
  @GetMapping
  public ResponseEntity<List<AgencyStaffResource>> getAllStaffByAgencyId(
      @PathVariable Long agencyId) {
  ...
  /** Get staff by id. */
  @GetMapping("/{staffId}")
  public ResponseEntity<AgencyStaffResource> getStaffById(
      @PathVariable Long agencyId, @PathVariable Long staffId) {
