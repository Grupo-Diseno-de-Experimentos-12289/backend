...
public class StripeWebhookController {
  ...
  public ResponseEntity<String> handleStripeWebhook(
      @RequestHeader(STRIPE_SIGNATURE_HEADER) String sigHeader, @RequestBody String payload) {
    try {
        ...
        if (intent != null) {
          ...
          bookingCommandService.handle(
              new ProcessPaymentCommand(
                  bookingId, intent.getPaymentMethod(), new TransactionId(transactionId)));
        }
      }
