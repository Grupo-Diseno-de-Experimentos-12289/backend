...
public class Booking extends AuditableAbstractAggregateRoot<Booking> {
  ...
  @Embedded private AvailabilityId availabilityId;
  ...
  public void addPayment(Payment payment) {
    ...
    if (this.bookingStatus != BookingStatus.PENDING) {
      throw new IllegalStateException(
          "Cannot add a payment to a booking that is not in PENDING status.");
    }
  ...
  public void addRefund(Refund refund) {
    ...
    if (this.bookingStatus != BookingStatus.SUCCEEDED
      ...
      throw new IllegalStateException(
          "Refunds can only be associated to bookings in SUCCEEDED or CANCELLED status.");
    }
    this.refund = refund;
  ...
  public void addPayout(Payout payout) {
    ...
    if (this.bookingStatus != BookingStatus.SUCCEEDED) {
      throw new IllegalStateException(
          "Payouts can only be processed for bookings in SUCCEEDED status.");
    }
    this.payout = payout;
  ...
  public void markAsSucceeded() {
    if (this.bookingStatus == BookingStatus.PENDING) {
      ...
      throw new IllegalStateException(
          "Booking can only be marked as SUCCEEDED from PENDING state.");
    }
  }
