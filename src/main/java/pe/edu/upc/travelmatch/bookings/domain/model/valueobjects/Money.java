...
/**
 * Money Value Object representing a monetary amount with currency. This class ensures type safety
 * and consistency when handling monetary values. Implements Domain-Driven Design (DDD) principles
 * as an embeddable value object.
 */
@Getter
@Embeddable
public class Money {
  ...
  /**
   * The monetary amount with precision of 10 total digits and 2 decimal places. Uses BigDecimal to
  ...
  /**
   * The currency code following ISO 4217 standard (e.g., "PEN", "USD", "EUR"). Limited to 3
   * characters as per ISO specification.
   */
  ...
  /**
   * Default constructor for JPA/Hibernate. Creates a Money object with zero amount in PEN currency.
   */
  protected Money() {
  ...
  /**
   * Adds another Money object to this one. Both Money objects must have the same currency.
   *
  ...
  /**
   * Subtracts another Money object from this one. Both Money objects must have the same currency.
   *
  ...
  /**
   * Checks if this Money is greater than another Money object. Both Money objects must have the
   * same currency.
   *
  ...
  /**
   * Checks if this Money is less than another Money object. Both Money objects must have the same
   * currency.
   *
   * @param other The Money object to compare with
  ...
  /**
   * Compares this Money object with another for equality. Two Money objects are equal if they have
