...
class CartsControllerTest {
    ...
    void testAddItem_Created() {
        ...
        when(cartCommandService.handle(any(AddCartItemCommand.class))).thenReturn(Optional.of(cartItem));
    ...
    void testAddItem_NotFound() {
        ...
        AddCartItemResource resource = new AddCartItemResource(101L, 2, java.math.BigDecimal.valueOf(49.99));
    ...
    void testAddItem_BadRequest() {
        // Arrange
        AddCartItemResource resource = new AddCartItemResource(101L, -1, java.math.BigDecimal.valueOf(49.99));
    ...
    void testUpdateItemQuantity_Ok() {
        ...
        when(cartCommandService.handle(any(UpdateCartItemQuantityCommand.class))).thenReturn(Optional.of(cartItem));
    ...
    void testUpdateItemQuantity_NotFound() {
        // Arrange
        UpdateCartItemQuantityResource resource = new UpdateCartItemQuantityResource(101L, 5);
        when(cartCommandService.handle(any(UpdateCartItemQuantityCommand.class))).thenReturn(Optional.empty());
