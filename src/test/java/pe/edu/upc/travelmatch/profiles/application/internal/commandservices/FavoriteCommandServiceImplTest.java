...
class FavoriteCommandServiceImplTest {
    ...
    void testHandle_DeleteFavoriteSuccessfully() {
        ...
        when(favoriteRepository.findByUserIdAndExperienceId(userId, experienceId)).thenReturn(Optional.of(favorite));
    ...
    void testHandle_DeleteFavorite_NotFound_ThrowsException() {
        ...
        when(favoriteRepository.findByUserIdAndExperienceId(userId, experienceId)).thenReturn(Optional.empty());
