...
public class CreateBookingCommandFromResourceAssemblerTest {
  ...
  void toCommandFromResource_validResource_mapsSuccessfully() {
    ...
    assertEquals(
        resource.availabilityId(), command.availabilityId(), "El AvailabilityID debe coincidir");
    ...
    assertEquals(
        resource.bookingDate(), command.bookingDate(), "La fecha de reserva debe coincidir");
  }
}
