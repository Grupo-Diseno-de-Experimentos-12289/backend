...
public class BookingAggregateTest {
    ...
    class StatusTransitions {
        ...
        void newBooking_statusIsPending() {
            ...
            Booking newBooking = new Booking(
                    new UserId(5L), new AvailabilityId(20L),
                    totalPrice, 1, BookingStatus.PENDING, Instant.now()
            );
    ...
    class PaymentAssociation {
        ...
        private Payment buildPayment(String txnId) {
            return new Payment(totalPrice, "card",
                    new TransactionId(txnId), PaymentStatus.PENDING, Instant.now());
        }
    }
    ...
    class PayoutAssociation {
        ...
        private Payout buildPayout() {
            return new Payout(5L, totalPrice,
                    BigDecimal.valueOf(0.10), PayoutStatus.PENDING, Instant.now());
        }
    }
