...
import pe.edu.upc.travelmatch.experiences.application.internal.commandservices.ExperienceCommandServiceImpl;
...
public class ExperienceCommandServiceImplTest {
    ...
    @InjectMocks
    private ExperienceCommandServiceImpl experienceCommandService;
    ...
    void handle_createExperience_allValid_experienceIsSaved() {
        ...
        when(categoryRepository.findByName(Categories.CULTURA)).thenReturn(Optional.of(existingCategory));
        ...
        when(experienceRepository.save(experienceCaptor.capture())).thenAnswer(inv -> inv.getArgument(0));
