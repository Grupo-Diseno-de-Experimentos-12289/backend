...
public class CreateExperienceCommandFromResourceAssemblerTest {
    ...
    void toCommandFromResource_ShouldMap() {
        //Arrange
        var resource = new CreateExperienceResource("experience1", "Description1","category1", 1L,"50 minutes","meet1");
        //Act

        CreateExperienceCommand exp = CreateExperienceCommandFromResourceAssembler.toCommandFromResource(resource,1L);
        //Assert
        assertNotNull(exp);
