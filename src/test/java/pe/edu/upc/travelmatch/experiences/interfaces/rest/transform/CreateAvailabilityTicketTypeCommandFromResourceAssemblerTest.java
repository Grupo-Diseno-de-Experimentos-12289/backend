...
public class CreateAvailabilityTicketTypeCommandFromResourceAssemblerTest {
    ...
    @Test
    @DisplayName("toCommandFromResource should map CreateAvailabilityTicketTypeResource to CreateAvailabilityTicketTypeCommand (AAA)")
    void toCommandFromResource_ShouldMap() {
        ...
        CreateAvailabilityTicketTypeCommand tick = CreateAvailabilityTicketTypeCommandFromResourceAssembler.toCommandFromResource(resource, avb);
