...
class ExperiencesControllerTest {
    ...
    @Mock
    private ExperienceCommandService commandService;

    @Mock
    private ExperienceQueryService queryService;
    ...
    void testCreateExperience_Created() {
        // Arrange
        Long agencyId = 1L;
        CreateExperienceResource resource = new CreateExperienceResource(
        ...
        when(queryService.handle(any(GetExperienceByIdQuery.class))).thenReturn(Optional.of(experience));

        // Act
        ResponseEntity<ExperienceResource> response = experiencesController.createExperience(agencyId, resource);
    ...
    void testCreateExperience_NotFound() {
        ...
        Long agencyId = 1L;
        CreateExperienceResource resource = new CreateExperienceResource(
                "Title", "Desc", "CULTURA", 1L, "1h", "Point");
    ...
    void testUpdateExperience_Ok() {
        ...
        UpdateExperienceResource resource = new UpdateExperienceResource(
        ...
        // Act
        ResponseEntity<ExperienceResource> response = experiencesController.updateExperience(experienceId, resource);
    ...
    void testUpdateExperience_NotFound() {
        ...
        Long experienceId = 10L;
        UpdateExperienceResource resource = new UpdateExperienceResource(
                "Title", "Desc", "CULTURA", 1L, "5h", "Point");
    ...
    void testGetExperienceById_Ok() {
        ...
        // Act
        ResponseEntity<ExperienceResource> response = experiencesController.getExperienceById(experienceId);
