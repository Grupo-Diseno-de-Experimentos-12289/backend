...
class AvailabilityCommandServiceImplTest {
    ...
    @InjectMocks
    private AvailabilityCommandServiceImpl availabilityCommandService;
    ...
    void handle_cuandoExperienciaNoExisteLanzaExcepcion() {
        ...
        // Act & Assert
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> availabilityCommandService.handle(command));
